                        ...
                        <div id="verifyEmailAlert"></div>
                            <div class="card-deck">
                                <div class="card border-primary">
                                    <div class="card-header bg-primary text-light text-center lead">User ID : <?= $cid; ?></div>
                                    <div class="card-body">
                                ...
                                <div class="card border-primary align-self-center">
                                    <?php if(!$cphoto): ?>
                                    <img src="assets/img/download.jpg" class="img-thumbnail img-fluid" width="408px">
                                    <?php else: ?>
                                    <img src="<?php 'assets/php/'.$cphoto; ?>" class="img-thumbnail img-fluid" width="408px">
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="changepassAlert"></div>
                            <div class="card-deck">
                                <div class="card border-success">
                                    ...
                                    <form action="#" method="post" class="px-3 mt-2" id="change-pass-form">
                                        <div class="form-group">
                                            <label for="curpass">Enter Your Current Passwoed</label>
                                        ...
                                        <div class="form-group">
                                            <label for="newpass">Enter New Passwoed</label>
                                        ...
                                        <div class="form-group">
                                            <label for="cnewpass">Enter New Passwoed</label>
                                ...
                                <div class="card border-success align-self-center">
                                    <img src="assets/img/download1.png" class="img-thumbnail img-fluid" width="408px">
                                </div>
                            </div>
                        </div>
        ...
        $("#changePassBtn").click(function(e){
            if($("#change-pass-form")[0].checkValidity()){
                ...
                if($("#newpass").val() != $("#cnewpass").val()){
                    $("#changepassError").text('* Please did not matched!');
